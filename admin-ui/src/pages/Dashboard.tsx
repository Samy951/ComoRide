    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="mt-4 text-lg font-medium text-gray-700">Chargement du tableau de bord...</p>
          <p className="text-sm text-gray-500">Récupération des données en temps réel</p>
        </div>
      </div>
    );
  }
